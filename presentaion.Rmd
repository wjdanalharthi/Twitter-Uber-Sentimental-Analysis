...
## Sentiment Polarity of Sentiment
I used the sentimental analysis above and combined the positive feelings (joy, trust, positive, anticipation) count, and the negative (anger, disgust, fear, sadness, negative) feelings count, and calculated the precentages of each. I created a table and used a pie chart to visualize it. 

  Again, here were see the overall breakdown of polarity of sentiment. Negative sentiment dominates the tweets overall.
