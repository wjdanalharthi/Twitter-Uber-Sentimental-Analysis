...
#tweets <- read.csv("./tweetsDF.csv", header=TRUE)
#tweets <- read.csv("./merged_tweets.csv", header=TRUE)
#tweets <- read.csv("./merged_tweets_2.csv", header=TRUE)
tweets <- read.csv("./tweetsDB.csv", header=TRUE)
...
#write.csv(df.sentiment, file="./general_sentiment.csv", row.names=FALSE)
#df.sentiment <- read.csv("./general_sentiment.csv", header=TRUE)
...
polatiryTable
#write.csv(polatiryTable, file="./polarity.csv", row.names=FALSE)
...
#write.csv(score, file="./detailed_sentiment.csv", row.names=FALSE)
#score <- read.csv("./detailed_sentiment.csv", header=TRUE)
...
ggsave("./EDA_sentimentRetweet.png")
